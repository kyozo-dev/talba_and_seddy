;メッセージレイヤの定義
		...
		[position width=1000 height=237 top=450 left=140 ]


		
			[position page=fore margint=45 marginl=30 marginr=30 marginb=10 vertical=false opacity="180" radius="0" color="0x000000" ]
		

		[ptext name="chara_name_area" layer="message0" color=0xFFFFFF size=26 x=160 y=470 bold="bold" edge="undefined" shadow="undefined"]
		...
		[position layer="message1" width=1000 height=237 top=450 left=140 ]
