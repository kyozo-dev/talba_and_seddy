;メッセージレイヤの定義
		...
		[position width=920 height=100 top=500 left=20 ]


		
			[position page=fore margint=20 marginl=10 marginr=20 marginb=10 vertical=false opacity="180" radius="0" color="0x000000" ]
		

		[ptext name="chara_name_area" layer="message0" color=0xFFFFFF size=23 x=30 y=510 bold="bold" edge="undefined" shadow="undefined"]
		...
		[position layer="message1" width=920 height=100 top=500 left=20 ]
